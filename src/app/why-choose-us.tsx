  ...
  return (
    <div className="flex gap-4">
      ...
      <div>
        ...
        <Typography className="mb-2 md:w-10/12 font-normal !text-gray-500" {...(undefined as any)}>
          {children}
        </Typography>
      </div>
    </div>
...
export function WhyChooseUs() {
  return (
    <section className="w-full max-w-4xl mx-auto flex flex-col items-center px-4 py-10">
      <Typography variant="h2" className="text-center mb-2" color="blue-gray" {...(undefined as any)}>
        Why choose our course?
      </Typography>
      <Typography
        variant="lead"
        className="mb-16 w-full text-center font-normal !text-gray-500 lg:w-10/12" {...(undefined as any)}
      >
